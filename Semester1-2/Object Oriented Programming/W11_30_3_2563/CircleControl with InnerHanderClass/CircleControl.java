...
public class CircleControl extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        //Register Event Handle to Buttons with Inner Handler Class
        enlargeBtn.setOnAction(new EnlargeBtnHandlerClass());
        shrinkBtn.setOnAction(new ShrinkBtnHandlerClass());
    ...
    //Inner Class for Handle Event
    private class EnlargeBtnHandlerClass implements EventHandler<ActionEvent>{
        @Override
        public void handle(ActionEvent arg0) {
            circlePane.enlarge();
        }
    }
    private class ShrinkBtnHandlerClass implements EventHandler<ActionEvent>{
        @Override
        public void handle(ActionEvent arg0) {
            circlePane.shrink();
        }
